...
import { Dumbbell, Mail, Instagram, Twitter } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-gray-400">Transform your fitness journey with personalized tracking and expert guidance.</p>
          </div>
